...
public interface SmsProperties {
    ...
    public static final String ENTITY_ID = "1701158107050838436"; //  "1401431560000050930";
    
    public static final String TEMPLATE_ID = "1707173432260079746";  //"1407166538256964841";
    
    public static final String SENDER_ID = "ERELGO"; //"MNSHFY";
